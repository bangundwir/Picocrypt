...
| Cipher         |✅ XChaCha20/AES‑256   |✅ AES-256      |✅ AES-256     |🟧 AES-128      |✅ AES-256     |
...
<ul>
	...
	<li><strong>AES‑256‑CTR mode</strong>: Choose AES‑256‑CTR instead of XChaCha20 if you need AES compatibility. Authentication and KDF remain identical to normal mode (BLAKE2b + Argon2id). Nonce/IVs are rotated safely during long streams.</li>
